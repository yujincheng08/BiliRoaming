...
class SSLHook(classLoader: ClassLoader):BaseHook(classLoader) {
    override fun startHook() {
        ...
        "javax.net.ssl.TrustManagerFactory".hookBeforeMethod(mClassLoader, "getTrustManagers") { param ->
            param.result = emptyTrustManagers
        }

        "javax.net.ssl.SSLContext".hookBeforeMethod(mClassLoader, "init", "javax.net.ssl.KeyManager[]", "javax.net.ssl.TrustManager[]", SecureRandom::class.java) { param ->
            param.args[0] = null
            param.args[1] = emptyTrustManagers
            param.args[2] = null
        }

        "javax.net.ssl.HttpsURLConnection".hookBeforeMethod(mClassLoader, "setSSLSocketFactory", javax.net.ssl.SSLSocketFactory::class.java) { param ->
            param.args[0] = "javax.net.ssl.SSLSocketFactory".findClass(mClassLoader)!!.new()
        }

        "org.apache.http.conn.scheme.SchemeRegistry".findClassOrNull(mClassLoader)?.hookBeforeMethod("register", "org.apache.http.conn.scheme.Scheme") { param ->
        ...
        "org.apache.http.conn.ssl.SSLSocketFactory".hookBeforeMethod(mClassLoader, "getSocketFactory") { param ->
            param.result = SSLSocketFactory::class.java.new()
        }

        "org.apache.http.conn.ssl.SSLSocketFactory".findClass(mClassLoader)?.hookAfterConstructor(String::class.java, KeyStore::class.java, String::class.java, KeyStore::class.java, SecureRandom::class.java, HostNameResolver::class.java) { param ->
        ...
        "org.apache.http.conn.ssl.SSLSocketFactory".hookAfterMethod(mClassLoader, "isSecure", Socket::class.java) { param ->
            param.result = true
        }

        "okhttp3.CertificatePinner".findClassOrNull(mClassLoader)?.hookBeforeMethod("findMatchingPins", String::class.java) { param ->
            param.args[0] = ""
        }
